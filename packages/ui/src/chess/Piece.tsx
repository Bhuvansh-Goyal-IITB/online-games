...
export const Piece: FC<PieceProps> = ({
  ...
  return (
    <div
      ...
      className={`absolute flex justify-center items-center touch-none w-[12.5%] h-[12.5%] z-[1] ${held ? "z-[2] grow-animation" : ""} ${promotionAnimate && canAnimate ? "translate-animation z-[2]" : ""}`}
      onDragStart={(e) => {
        e.preventDefault();
      }}
      onContextMenu={(e) => {
